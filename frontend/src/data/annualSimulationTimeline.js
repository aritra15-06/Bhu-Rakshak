...
export function getDailySimulationState(dayOfYear, customSites = {}) {
  ...
  return {
    ...
    regions: {
      LOC01: {
        location_id: "LOC01",
        name: "Dikchu Teesta Valley Left Slope",
        elevation_m: 1780,
      ...
      LOC02: {
        location_id: "LOC02",
        name: "Chungthang Hydel Cut & Valley Junction",
        elevation_m: 1420,
      ...
      LOC04: {
        ...
        elevation_m: 1910,
        dem_crest_elevation_m: 2050,
        dem_toe_elevation_m: 1910,
        dem_horizontal_run_m: 145,
        dem_delta_z_m: 140,
      ...
      LOC05: {
        ...
        elevation_m: 580,
        dem_crest_elevation_m: 650,
        dem_toe_elevation_m: 580,
      ...
      LOC06: {
        location_id: "LOC06",
        name: "Mangan Ridge Highway Cut",
        elevation_m: 1220,
        dem_crest_elevation_m: 1380,
        dem_toe_elevation_m: 1220,
